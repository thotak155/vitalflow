...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ai_scribe_code_suggestions: {
        Row: {
          ...
          source: string;
          tenant_id: string;
          type: Database["public"]["Enums"]["ai_code_type"];
        };
        Insert: {
          accepted_at?: string | null;
          accepted_by?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "ai_scribe_code_suggestions_encounter_id_fkey";
          ...
          {
            foreignKeyName: "ai_scribe_code_suggestions_session_id_fkey";
            columns: ["session_id"];
            isOneToOne: false;
            referencedRelation: "ai_scribe_sessions";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "ai_scribe_code_suggestions_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
      ...
      ai_scribe_sessions: {
        Row: {
          ...
          encounter_id: string;
          error_message: string | null;
          generate_request_id: string | null;
          id: string;
          metadata: Json;
          patient_id: string;
          source: Database["public"]["Enums"]["ai_scribe_source"];
          status: Database["public"]["Enums"]["ai_scribe_session_status"];
          suggest_request_id: string | null;
          tenant_id: string;
          total_cost_micros_usd: number | null;
          total_latency_ms: number | null;
          transcribe_request_id: string | null;
          updated_at: string;
        };
        Insert: {
          accepted_note_id?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "ai_scribe_sessions_accepted_note_id_fkey";
            columns: ["accepted_note_id"];
            isOneToOne: false;
            referencedRelation: "clinical_notes_current";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "ai_scribe_sessions_accepted_note_id_fkey";
          ...
          {
            foreignKeyName: "ai_scribe_sessions_encounter_id_fkey";
            columns: ["encounter_id"];
            isOneToOne: false;
            referencedRelation: "encounters";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "ai_scribe_sessions_generate_request_id_fkey";
            columns: ["generate_request_id"];
            isOneToOne: false;
            referencedRelation: "ai_requests";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "ai_scribe_sessions_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "ai_scribe_sessions_suggest_request_id_fkey";
            columns: ["suggest_request_id"];
            isOneToOne: false;
            referencedRelation: "ai_requests";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "ai_scribe_sessions_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "ai_scribe_sessions_transcribe_request_id_fkey";
            columns: ["transcribe_request_id"];
            isOneToOne: false;
            referencedRelation: "ai_requests";
            referencedColumns: ["id"];
          },
      ...
      ai_scribe_transcript_segments: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_scribe_transcript_segments_session_id_fkey";
            columns: ["session_id"];
            isOneToOne: false;
            referencedRelation: "ai_scribe_sessions";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "ai_scribe_transcript_segments_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
      ...
      denials: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "denials_claim_line_id_fkey";
          ...
          {
            foreignKeyName: "denials_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
      ...
      diagnosis_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "diagnosis_assignments_encounter_id_fkey";
            columns: ["encounter_id"];
            isOneToOne: false;
            referencedRelation: "encounters";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "diagnosis_assignments_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
            referencedRelation: "patients";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "diagnosis_assignments_problem_id_fkey";
            columns: ["problem_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "diagnosis_assignments_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
      ...
      patient_balances: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_balances_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
            referencedRelation: "patients";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "patient_balances_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
    ...
    Enums: {
      ai_code_type: "diagnosis" | "procedure";
      ai_provider: "anthropic" | "openai" | "google";
      ai_request_status: "pending" | "streaming" | "completed" | "failed" | "blocked";
      ai_safety_verdict: "pass" | "warn" | "block";
      ai_scribe_session_status:
        | "pending"
        | "transcribing"
        | "generating"
        | "suggesting_codes"
        ...
        | "cancelled"
        | "failed";
      ai_scribe_source: "audio_upload" | "transcript_paste" | "stream";
      ...
      claim_status:
        ...
        | "appealed"
        | "closed";
      contact_type: "phone_home" | "phone_mobile" | "phone_work" | "email" | "address";
      coverage_type:
        | "primary"
        | "secondary"
        | "tertiary"
      ...
      integration_type:
        ...
        | "generic_webhook"
        | "oauth_smart";
      inventory_txn_type: "receipt" | "dispense" | "waste" | "transfer" | "adjustment" | "return";
      invitation_status: "pending" | "accepted" | "revoked" | "expired";
      invoice_status: "draft" | "issued" | "paid" | "partial" | "void" | "written_off" | "refunded";
      ...
      order_result_status: "preliminary" | "final" | "amended" | "cancelled" | "corrected";
      order_status: "draft" | "ordered" | "in_progress" | "completed" | "cancelled" | "amended";
      order_type: "lab" | "imaging" | "medication" | "referral" | "procedure" | "nursing";
      payment_method:
        | "cash"
        | "check"
        | "card"
      ...
      task_status: "pending" | "assigned" | "in_progress" | "blocked" | "completed" | "cancelled";
      ...
      workflow_run_status: "pending" | "running" | "paused" | "completed" | "failed" | "cancelled";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
