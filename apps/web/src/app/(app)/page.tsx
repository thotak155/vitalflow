...
const columns: readonly DataTableColumn<PatientRow>[] = [
  ...
  { id: "last", header: "Last visit", cell: (r) => r.lastVisit },
  {
    ...
    cell: (r) => {
      const variant =
        r.status === "active" ? "success" : r.status === "follow_up" ? "warning" : "muted";
      const label =
        r.status === "follow_up" ? "Follow-up" : r.status[0]!.toUpperCase() + r.status.slice(1);
  ...
  return (
    <>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader>
            <CardTitle>Open encounters</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Unsigned notes</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-destructive text-3xl font-semibold">1</div>
          </CardContent>
        </Card>
      </div>
